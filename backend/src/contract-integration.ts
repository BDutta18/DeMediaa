...
export const CONTRACT_ENV_KEYS = ["PRIVATE_KEY", "CONTRACT_ADDRESS_CONTENTREGISTRY"] as const
...
const getMissingEnvKeys = (): string[] => CONTRACT_ENV_KEYS.filter((key) => !process.env[key])
